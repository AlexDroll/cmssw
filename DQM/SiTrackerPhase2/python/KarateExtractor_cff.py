...
from DQM.SiTrackerPhase2.KarateExtractor_cfi import *


pixDigiMon = digiMon.clone()
pixDigiMon.PixelPlotFillingFlag = cms.bool(True)
pixDigiMon.TopFolderName = cms.string("KarateExtractorITDigi")
...
otDigiMon.TopFolderName = cms.string("KarateExtractorOTDigi")
